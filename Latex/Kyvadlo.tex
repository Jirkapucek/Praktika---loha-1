...
\begin{document}
	...
	\addtocontents{toc}{\protect\begin{multicols}{2}}
		...
		\begin{figure}[h]
			...
			\caption*{\textbf{Graf 2.} Závislost T na $\theta_{0}$}  
		\end{figure}
		\\
		...
		\begin{figure}[h]
			...
			\caption*{\textbf{Graf 3.} explixitní Euler vs automatická metoda v NDSolve}  
		\end{figure}
		\\
		\\
		...
		\begin{figure}[h]
			...
			\caption*{\textbf{Graf 4.} Eulerova metoda a energie}  
		\end{figure}
		\\
		\\
